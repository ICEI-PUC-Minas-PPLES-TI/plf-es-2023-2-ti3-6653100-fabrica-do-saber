...
public class Person {
    ...
    @Column(name = "cpf", length = 14, nullable = true, unique = false, updatable = false)
    @Pattern(regexp = "\\d{3}\\.\\d{3}\\.\\d{3}-\\d{2}")
    private String cpf;

    @Column(name = "rg", length = 45, nullable = true, unique = false, updatable = false)
    ...
    @Column(name = "phone_number", length = 45, nullable = true, unique = false, updatable = true)
